...
<form class="max-w-sm mx-auto mt-9 " action="index.php?act=updateAcc" method="post">
    ...
    <div class="mb-5">
        ...
        <input type="text"
            class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500  block w-full p-2.5  focus:border-blue-500"
         name="avater" value="<?php echo $acc['avater'] ?>">
    </div>
    <div class="mb-5">
...
<input type="text" hidden value="<?php echo $acc['id'] ?>" name="id">
        ...
        <a href="index.php?act=listAcc" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">Danh Sách</a>
    </div>
</form>