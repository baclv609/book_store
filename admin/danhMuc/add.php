...
<form class="max-w-sm mx-auto mt-9 " action="index.php?act=addDm" method="post">
    <div class="mb-5">
    ...
    <div class="flex items-center mb-5">
        ...
        <a href="index.php?act=listDm" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">Danh Sách</a>
    </div>
</form>