    ...
    <div class="container-content grid lg:grid-cols-2 xl:grid-cols-3 gap-4 h-full">
        ...
        <div class="bg-[#3f3f3f] lg:h-screen lg:sticky lg:top-0  rounded-xl">
            <div class="relative h-full">
                <div class="p-8 lg:overflow-auto lg:h-[calc(100vh-60px)]">
                    <h2 class="text-2xl font-bold text-white">Tóm tắt theo thứ tự</h2>
        ...
        <div class="xl:col-span-2 h-max rounded-md p-8 sticky top-0">
            ...
            <form class="mt-10">
                ...
                <div class="mt-6">
                    <h3 class="text-lg font-bold text-[#333] mb-6">Địa chỉ giao hàng</h3>
                    <div class="grid sm:grid-cols-2 gap-6">
                    ...
                    <div class="flex gap-6 max-sm:flex-col mt-10">
                        <button type="button"
                            class="rounded-md px-6 py-3 w-full text-sm font-semibold bg-transparent hover:bg-gray-100 border-2 border-[#C92127] text-[#C92127]">Hủy
                            bỏ</button>
                        <button type="button"
                            class="rounded-md px-6 py-3 w-full text-sm font-semibold bg-[#C92127] text-white hover:bg-[#dd292f]">Hoàn
                            tất mua hàng</button>
                    </div>
                </div>
            </form>
